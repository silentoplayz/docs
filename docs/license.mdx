...
[**View the full license on GitHub →**](https://github.com/open-webui/open-webui/blob/main/LICENSE)
...
To keep Open WebUI thriving for the long term, we’ve introduced a **lightweight branding protection clause** with Open WebUI v0.6.6+ that helps us sustain the project while keeping the core experience accessible to all users. Branding requirements **only apply to larger deployments (50+ users, aggregate)**. Self-hosted internal deployments with 50 or fewer users may fully rebrand if they choose.

As a small, independent team building mission-critical AI tooling, we rely on fair attribution to keep the project visible and discoverable, and that visibility is what drives the enterprise licensing and sponsorship that ultimately **funds the ongoing development, security, and quality that keeps Open WebUI free for everyone**, all without restricting real users, contributors, or businesses who use Open WebUI responsibly.
...
We remain committed to transparency, openness, and supporting everyone, from hobbyists to enterprise. This is a “semi-copyleft” measure: we protect just the branding, to keep the project honest and sustainable; the code itself remains as open as you'd expect.

We want Open WebUI to stay empowering and accessible, not gated, not locked-in. Thank you for supporting us and the future of Open WebUI.
...
Under permissive licenses like BSD-3-Clause, anyone who receives the code has the freedom to use, modify, rebrand, and redistribute it, including under different terms. That freedom applies equally to maintainers and users. Our mission is to make AI accessible to everyone, and we made the licensing decision we believe best sustains that mission for the long term. The Open WebUI codebase up to and including v0.6.5 is BSD-3-Clause, and that cannot be changed retroactively. If you disagree with this direction, you have the same freedom to make your own choice: [fork from v0.6.5](https://github.com/open-webui/open-webui/tree/v0.6.5) and build on it however you see fit, with no restrictions. The more people working to make AI accessible, the better. See the [license history](https://github.com/open-webui/open-webui/blob/main/LICENSE_HISTORY) for details.
...
- Includes an additional branding restriction clause:
  ...
  - Branding must remain clearly visible, unless:
    ...
    2. **You qualify as a substantive contributor [^1]** and have obtained specific prior written permission from us for branding adjustment;
...
- You qualify as a substantive contributor [^1] **and** have received written permission for branding adjustment; or
...
[^1]: "Substantive contributor" means someone who has demonstrated sustained, meaningful contributions to the project over time. We look for long-term involvement, consistency, and non-trivial impact to the codebase. Written permission for branding adjustment is evaluated on a case-by-case basis, and this status **applies only in exceptional cases**.
...
Open source works when everyone benefits. We've always believed that, and we still do. But sustainability requires protecting the project from patterns that undermine it.
...
- In some cases, they even go further by intentionally obscuring the fact that Open WebUI is available for free, so that they can charge users significant fees for something freely available.
...
- When things break or customers need feature updates, these same groups turn around and *rely on us, the original developers, for support **while never having contributed a line of code, a helpful bug report, documentation, or any resources back to the project.***
- **In effect, they extract value from the collective effort of independent contributors, misrepresent their role in the project, and operate without contributing back to the ecosystem or its sustainability.**

Let's be clear:
- **Not everyone who doesn't contribute is acting in bad faith.** Using Open WebUI "as is," for internal or not-for-profit ways, is absolutely fine. We expect most users will never contribute code, and that's totally fair, that's how permissive open source works!
- **But there is a line:** When you start misleading your users about what you're offering, exploiting the goodwill and energy of independent maintainers, and taking more than you give (especially when making money and actively denying credit), **that goes beyond fair use of an open-source project.**
...
**That's why** the new branding clause exists. Long-term sustainability is a core motivation, and many widely used open-source projects have adopted similar or even stricter measures to stay viable. We chose a lightweight path: protect the brand, keep the code open.
...
- It prevents our contributions from being concealed or misrepresented, protecting the project's identity, trust, and reputation.
...
The **branding protection clause asks one thing: keep our name visible.** Visible branding costs users nothing, but it connects the software to the team behind it, and that connection is what keeps the project alive for everyone.

None of this changes the deal for previous contributors. All pre-v0.6.6 code stays BSD-3, and anyone who disagrees with this direction is free to fork from v0.6.5 and build from there. We remain as open, reasonable, and fair as ever, and we trust the community to do the right thing.
...
- **Importantly:** The new license with the branding protection clause is **not being retroactively applied to the entire codebase**. All external/community-contributed code merged before v0.6.6 remains pure BSD-3 and is not covered by the branding clause, **no retroactive relicensing or constraints** will be applied to anyone else's past contributions.
...
- **If you contributed code pre-v0.6.6 and would prefer to have it removed from future releases, we're happy to accommodate.** Just reach out to us and reference the relevant code. We respect every contributor's wishes and will handle removal promptly.
...
**Open WebUI v0.6.6+ is not an OSI-approved "open source" license.** Our branding clause means the license would not meet OSI's certification criteria.
...
- *You can fork, extend, and submit PRs.*

**Why this approach?**

When open source projects grow, they can face difficult choices about how to handle exploitation, misattribution, and long-term sustainability. Some projects in our position have responded by closing the source entirely, adopting restrictive licenses like SSPL or BSL that limit commercial use, or separating features into a private enterprise fork.

We chose to protect our branding because we want a single, shared, public codebase where everyone, from individual developers to enterprises, can benefit from the same core improvements, transparent development, and community contributions.

We believe open ecosystems work best for users, contributors, and the future of AI. If you ever need more permissions or have questions, just talk to us.
...
- Co-branding is not permitted. You may not place your own logo alongside, adjacent to, or in comparable prominence to the Open WebUI logo or name.
...
- **Do not place your logo next to ours.** Co-branding is not permitted under any license tier except enterprise.
