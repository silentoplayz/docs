...
The authoritative version of this policy lives in the [GitHub Security Policy](https://github.com/open-webui/open-webui/security). This page is a summary of its key principles for quick reference. In case of any discrepancy, the GitHub version prevails.
...
Open WebUI is designed for private, trusted networks and ships with defaults optimized for ease of setup. Production deployments handling sensitive data should review the [Hardening Guide](https://docs.openwebui.com/getting-started/advanced-topics/hardening) for a comprehensive checklist.
